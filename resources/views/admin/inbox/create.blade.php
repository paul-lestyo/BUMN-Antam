        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <a href="{{ route('admin.inbox.index') }}" class="btn btn-light btn-sm"><i
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.inbox.reply', $inbox->id) }}">
                                @csrf
								<div class="form-group">
                                    <label for="subject">Kepada</label>
                                    <input type="text" class="form-control"
                                        placeholder="Masukan Subject Pesan" value="{{ $inbox->dataPengirim->nama_pegawai . ' - ' . $inbox->subject }}" disabled>
                                </div>
								<div class="form-group">
