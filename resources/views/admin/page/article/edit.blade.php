                                ...
                                @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ $article->judul }}">
                                            @error('judul')
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('author') is-invalid @enderror" id="author" name="author" value="{{ $article->author }}">
                                            @error('author')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
										...
										<div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" value="{{ $article->category }}">
                                            @error('category')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group col-md-12">
											<label for="img">Gambar Lama</label><br>
											<img src="{{ $article->img }}" style="max-width: 300px"><br>
