                              ...
                              @method('PUT')
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input type="text" value="{{ old('nama_divisi',$divisi->nama_divisi) }}" class="form-control @error('nama_divisi') is-invalid @enderror" id="nama_divisi" name="nama_divisi" placeholder="Masukan Nama Divisi">
                                        @error('nama_divisi')
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <button type="submit" class="btn btn-primary form-control"><i class="fa fa-save mr-1"></i> Ubah Data</button>
                                    </div>
                                </div>
                            </form>
                        </div>
